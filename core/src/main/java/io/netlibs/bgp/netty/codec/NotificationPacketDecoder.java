...
import io.netlibs.bgp.netty.protocol.BadMessageTypeNotificationPacket;
import io.netlibs.bgp.netty.protocol.CeaseNotificationPacket;
import io.netlibs.bgp.netty.protocol.ConnectionCollisionResolutionNotificationPacket;
import io.netlibs.bgp.netty.protocol.ConnectionNotSynchronizedNotificationPacket;
import io.netlibs.bgp.netty.protocol.ConnectionRejectedNotificationPacket;
import io.netlibs.bgp.netty.protocol.FiniteStateMachineErrorNotificationPacket;
import io.netlibs.bgp.netty.protocol.HoldTimerExpiredNotificationPacket;
import io.netlibs.bgp.netty.protocol.MaximumNumberOfPrefixesReachedNotificationPacket;
import io.netlibs.bgp.netty.protocol.MessageHeaderErrorNotificationPacket;
import io.netlibs.bgp.netty.protocol.NotificationPacket;
import io.netlibs.bgp.netty.protocol.OtherConfigurationChangeNotificationPacket;
