 ...
 */
package io.joss.bgp.config.global;
...
public class PeerConfigurationEvent extends TypedEvent
{
  ...
  private final PeerConfiguration former;
  private final PeerConfiguration current;

  public PeerConfigurationEvent(final EventType type, final PeerConfiguration former, final PeerConfiguration current)
  {
    super(type);
