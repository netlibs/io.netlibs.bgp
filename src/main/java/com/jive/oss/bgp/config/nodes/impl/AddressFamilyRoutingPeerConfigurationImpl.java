...
import com.jive.oss.bgp.config.nodes.AddressFamilyRoutingPeerConfiguration;
...
public class AddressFamilyRoutingPeerConfigurationImpl implements AddressFamilyRoutingPeerConfiguration {
	...
	/* (non-Javadoc)
	 * @see org.bgp4j.config.nodes.AddressFamilyRoutingPeerConfiguration#getAddressFamilyKey()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.bgp4j.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalDefaultPathAttributes()
	 */
	
	/* (non-Javadoc)
	 * @see org.bgp4j.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalRoutingFilters()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.bgp4j.config.nodes.AddressFamilyRoutingPeerConfiguration#getRemoteRoutingFilters()
	 */
	@Override
