...
public class PeerConfigurationDecorator implements PeerConfiguration {
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getClientConfig()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getLocalAS()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getRemoteAS()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getPeerName()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getRemoteBgpIdentifier()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getLocalBgpIdentifier()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getHoldTime()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getIdleHoldTime()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isAllowAutomaticStart()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isAllowAutomaticStop()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isDampPeerOscillation()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isPassiveTcpEstablishment()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isDelayOpen()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getDelayOpenTime()
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#isCollisionDetectEstablishedState()
	 */
	 ...
	 * @param other
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#equals(java.lang.Object)
	 */
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#hashCode()
	 */
	public int hashCode() {
	...
	/**
	 * @return
	 * @see com.jive.oss.bgp.config.nodes.PeerConfiguration#getConnectRetryTime()
	 */
