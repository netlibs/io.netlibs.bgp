...
public class PeerConfigurationDecorator implements PeerConfiguration {
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getClientConfig()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getLocalAS()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getRemoteAS()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getPeerName()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getRemoteBgpIdentifier()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getLocalBgpIdentifier()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getHoldTime()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getIdleHoldTime()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isAllowAutomaticStart()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isAllowAutomaticStop()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isDampPeerOscillation()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isPassiveTcpEstablishment()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isDelayOpen()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getDelayOpenTime()
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#isCollisionDetectEstablishedState()
	 */
	 ...
	 * @param other
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#equals(java.lang.Object)
	 */
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#hashCode()
	 */
	public int hashCode() {
	...
	/**
	 * @return
	 * @see io.joss.bgp.config.nodes.PeerConfiguration#getConnectRetryTime()
	 */
