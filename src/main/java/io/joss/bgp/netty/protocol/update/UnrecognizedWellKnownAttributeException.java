...
public class UnrecognizedWellKnownAttributeException extends AttributeException
{
   ...
   */
  public UnrecognizedWellKnownAttributeException(final byte[] offendingAttribute)
  {
   ...
   * @param offendingAttribute
   */
  public UnrecognizedWellKnownAttributeException(final String message,
   ...
   * @param buffer
   */
  public UnrecognizedWellKnownAttributeException(final ByteBuf buffer)
  {
    super(buffer);
  }
   ...
   * @param buffer
   */
  public UnrecognizedWellKnownAttributeException(final String message, final ByteBuf buffer)
  {
  ...
  {
    return new UnrecognizedWellKnownAttributeNotificationPacket(this.getOffendingAttribute());
  }
