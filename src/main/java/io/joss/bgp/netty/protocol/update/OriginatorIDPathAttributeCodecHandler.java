...
PathAttributeCodecHandler<OriginatorIDPathAttribute>
{
   ...
   */
  @Override
  public int typeCode(final OriginatorIDPathAttribute attr)
  {
   ...
   */
  @Override
  public int valueLength(final OriginatorIDPathAttribute attr)
  {
    return 4;
  }
   ...
   */
  @Override
  public ByteBuf encodeValue(final OriginatorIDPathAttribute attr)
  {
