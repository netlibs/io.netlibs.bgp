 ...
 *
 * File: org.bgp4j.netty.protocol.update.LocalPrefPathAttributeCodecHandler.java
 */
...
PathAttributeCodecHandler<LocalPrefPathAttribute>
{
   ...
   */
  @Override
  public int typeCode(final LocalPrefPathAttribute attr)
  {
   ...
   */
  @Override
  public int valueLength(final LocalPrefPathAttribute attr)
  {
    return 4;
  }
   ...
   */
  @Override
  public ByteBuf encodeValue(final LocalPrefPathAttribute attr)
  {
